...
(function () {
  ...
  defaultOptions= {
    catchupTime: 500, initialRate: .03, minTime: 500, ghostTime: 500, maxProgressPerFrame: 10, easeFactor: 1.25, startOnPageLoad: true, restartOnPushState: true, restartOnRequestAfter: 500, target: 'body', elements: {
    ...
    , ajax: {
      trackMethods: ['GET'], trackWebSockets: false
    }
  }
      ...
      if ((_WebSocket !=null) && options.ajax.trackWebSockets) {
        window.WebSocket=function (url, protocols) {
          ...
          if (shouldTrack('socket')) {
            _this.trigger('request', {
              type: 'socket', url: url, protocols: protocols, request: req
            }
  ...
  SOURCE_KEYS= {
    ajax: AjaxMonitor, elements: ElementMonitor, document: DocumentMonitor, eventLag: EventLagMonitor
  }
  ...
  Pace.go=function () {
    ...
    return animation=runAnimation(function (frameTime, enqueueNextFrame) {
      ...
      for (i=_j=0, _len1=sources.length;
      _j < _len1;
      ...
      i=++_j) {
        ...
        for (j=_k=0, _len2=elements.length;
        _k < _len2;
